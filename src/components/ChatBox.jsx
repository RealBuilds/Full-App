  ...
  return (
    <aside className="w-80 bg-gray-50 border-l border-gray-200 flex-shrink-0 flex flex-col">
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-gray-900 font-bold text-xl">Live Chat</h3>
      </div>
        ...
        {chatMessages.map((msg, idx) => (
          <div key={idx} className="flex items-start gap-3">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm mt-1 shadow-md ${
              ...
              {msg.role === 'streamer' && <Crown className="w-4 h-4" />}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="bg-white rounded-lg px-4 py-3 text-gray-800 text-sm break-words shadow-sm border border-gray-100">
                {msg.message}
              </div>
            </div>
          </div>
