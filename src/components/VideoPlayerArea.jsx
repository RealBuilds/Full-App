  ...
  return (
    <main className="flex-1 bg-gray-900 flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center p-6">
        <div className="relative w-full h-full max-w-5xl aspect-video bg-black rounded-2xl flex items-center justify-center shadow-2xl">
          {/* Play Button */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <div className="text-gray-900 font-bold text-2xl mb-1">Ral Nwogbo</div>
                  <div className="text-gray-600 text-lg">NFL Player</div>
                </div>
              </div>
