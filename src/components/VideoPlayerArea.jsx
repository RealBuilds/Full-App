  ...
  return (
    <main className="flex-1 bg-gray-900 flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center">
        <div className="relative w-full h-full max-w-4xl aspect-video bg-black rounded-lg flex items-center justify-center">
          {/* Play Button */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className="text-gray-900 font-bold text-lg">Ral Nwogbo</div>
